...
DIAGNOSE="$ROOT/install-media/usr/local/bin/omarchy-install-diagnose-media"
DASHBOARD="$ROOT/install-media/usr/local/bin/omarchy-install-dashboard"
...
{"current_phase": "Installing Artix + Omarchy",
 "phases": [{"name": "Installing Artix + Omarchy", "status": "failed",
