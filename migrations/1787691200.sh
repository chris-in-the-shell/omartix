echo "Skip Chromium's new first-run EULA on existing installations"
...
# binary, but that seed is only laid down by a fresh install. Retrofit it on
# installations created before the seed existed.
#
